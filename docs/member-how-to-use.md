...
**Reply 10 at any time** for an immediate emergency response.

---

## STEP 3 — STARTING A TRIP (THE MAIN FEATURE)
...
> *Leaving Fourways now heading to Pretoria, should be there by 6pm*

or the structured format:
...
Your ETA has shifted. Quick update?

1. ✅ I'm fine — on my way
2. 🕐 Delayed but safe
3. 🕐 I have a new ETA
4. 🛑 I've stopped — engine/flat/etc
5. 🆘 I need help — SOS
...
**Any of the following will trigger an immediate emergency response:**
...
| **Emergency** | RED alert — André notified — ICE contact WhatsApp'd |
| **Danger** | RED alert — André notified — ICE contact WhatsApp'd |
| **Hijack** | RED alert — André notified — ICE contact WhatsApp'd |
| Choice **5** in check-in | RED alert — André notified — ICE contact WhatsApp'd |

When a RED alert fires:
1. André's personal phone is alerted immediately
...
## STEP 7 — YOUR PROFILE (SET IT UP ONCE)
...
| **Hi** / **Menu** / **0** | Main menu |
| **5** | Start a trip |
| **START [from] to [dest] ETA [time]** | Start a trip (structured) |
| **Home** / **Arrived** / **Safe** | Close active trip |
| **10** | Emergency — wake up the Situation Room |
| **HELP** / **SOS** | Emergency — RED alert + ICE WhatsApp |
...
*eblockwatch — André Snyman's trusted human network, built over 25 years.*
*Every member makes the spine stronger.*
