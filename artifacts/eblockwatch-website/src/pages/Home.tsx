        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "#4b5563", lineHeight: 1.7, marginBottom: "32px", fontSize: "15px" }}>
              Have a safety question? Arnie is available 24/7 to guide you through Cyber Chaperone, explain how trips work, and give you peace of mind before you travel.
            </p>
            <a
              href={WA_LINK_HI}
              target="_blank"
            ...
            >
              <WhatsAppIcon />
              Chat with Arnie on WhatsApp
            </a>
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <img src={AI_CHAT_IMG} alt="Arnie chat interface" style={{ maxWidth: "100%", borderRadius: "16px", boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }} />
          </div>
        </div>
      </section>
