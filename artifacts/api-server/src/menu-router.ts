...
function ccInfoText(name: string): string {
  return [
    ...
    ``,
    `When you drive — kick-start your trip and we monitor you.`,
    ...
    ``,
    `─── 🚗 On the road ───`,
    `When you get in the car, kick-start your trip.`,
    `Tell Arnie where you're going and when you expect to arrive.`,
    `We watch your route silently. If you don't arrive — we act.`,
    ``,
    `🟢 Start — reply *1*, tell Arnie your route and ETA`,
