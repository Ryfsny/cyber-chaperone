...
export async function handleMenuRouter(ctx: MenuContext): Promise<MenuResult> {
  ...
  if (/^9$/.test(trimmed)) {
    ...
    await sendWhatsApp(from, to, [
      ...
      ``,
      `We check on you in three steps.`,
      `We never jump straight to the last one.`,
      ``,
      `*Step 1 — We message YOU*`,
      `We send you a message: "Are you okay?"`,
      `You reply. Done. No fuss.`,
      ``,
      `*Step 2 — We contact your emergency person*`,
      `You did not reply.`,
      `We message the person you told us about.`,
      `They check on you and let us know you are safe.`,
      ``,
      `*Step 3 — We open a wider search*`,
      `Your emergency person cannot reach you.`,
      `Now we use everything you told us.`,
      `Your address. Your area. Our network of helpers.`,
      `We find someone near you who can help.`,
      ``,
      `⚠️ *This is why filling in your profile matters.*`,
      `The more you tell us — the better we can find you.`,
      `We cannot help properly if we do not know who you are.`,
      `━━━━━━━━━━━━━━━━━━━━`,
      ``,
      `At any time:`,
      `• Reply *0* → Main Menu`,
