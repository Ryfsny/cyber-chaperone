...
function ccInfoText(name: string): string {
  return [
    ...
    ``,
    `─── 🏠 In your safe zone ───`,
    `Your safe zone is wherever you feel comfortable — home, office, a friend's place.`,
    `While you're there, Cyber Chaperone is your direct line to the Situation Room and André.`,
    `Use it any time — to report something, ask a question, or just know someone is there.`,
    `• Reply *7* to speak to André directly`,
    `• Reply *10* for an immediate emergency response`,
    ``,
    `─── 🚗 When you roam ───`,
    `The moment you leave your safe zone, you're roaming.`,
    `That could be a drive across the country, a walk around the block, or a morning run.`,
    `Start a trip and we monitor you until you're safely back.`,
    ``,
    `🟢 Start — reply *1*, tell Arnie where you're going`,
    `🔵 Monitor — we watch silently in the background`,
    `📍 Check-ins — we prompt you if your ETA passes`,
    `✅ Arrive — reply *SAFE* and your trip is closed`,
    `🆘 Emergency — reply *HELP* or *10* and we act immediately`,
    ``,
    `In your safe zone or on the road — André is watching.`,
    `You are never alone.`,
    ``,
    `Reply 0 for Main Menu.`,
  ].join("\n");
