...
function mainMenuText(name: string, member: MemberInfo | null): string {
  ...
  if (isOperator) {
    return [
      ...
      ``,
      `1️⃣  Cyber Chaperone 🛡️ — at home or on the road, we've got you`,
...
function ccMenuText(name: string): string {
  return [
    ...
    ``,
    `Your connection to eblockwatch — whether you're at home or on the road.`,
    ``,
    `─── 🏠 At home ───`,
    `5️⃣  I need help 🆘`,
...
function ccInfoText(name: string): string {
  return [
    ...
    ``,
    `The word says it: we chaperone you — whether you're at home or on the road.`,
    `eblockwatch has been keeping South Africans safe for over 20 years.`,
    `Cyber Chaperone is how you connect to that network from your phone.`,
    ``,
    `─── 🏠 At home ───`,
    `You can reach the Situation Room and André any time — not just when you travel.`,
    `Need to report something, ask a question, or just feel safer? We're here.`,
    `• Reply *7* to speak to André directly`,
    `• Reply *10* for an immediate emergency response`,
    ``,
    `─── 🚗 When you roam ───`,
    `Tell us where you're going and when you'll arrive. We watch your route.`,
    `If you don't check in — we check on you.`,
    `If we can't reach you — we call your ICE contact.`,
    ``,
    `🟢 Start — reply *1* and tell Arnie your route`,
    `🔵 Monitor — we watch silently in the background`,
    `📍 Check-ins — gentle prompts if your ETA passes`,
    `✅ Arrive — reply *SAFE* and your trip is closed`,
    `🆘 Emergency — reply *HELP* or *10* and we act immediately`,
    ``,
    `André is watching. You are never alone — at home or on the road.`,
    ``,
    `Reply 0 for Main Menu.`,
  ].join("\n");
}
