...
export const ListTripsResponseItem = zod.object({
  ...
  lastKnownLat: zod.string().nullish(),
  lastKnownLon: zod.string().nullish(),
  lastKnownAt: zod.coerce.date().nullish(),
  lastLocationSource: zod.string().nullish(),
  checkinStage: zod.string().nullish(),
  overdueMinutes: zod.number().nullish(),
